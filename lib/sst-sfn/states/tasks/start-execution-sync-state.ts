...
export type StartExecutionSyncParams = Omit<TaskStateBaseParams<StartExecutionSyncTaskParameters>, "Resource">;

export class StartExecutionSync extends TaskStateBase<StartExecutionSyncTaskParameters> {
  constructor(
    public name: string,
    params: Omit<TaskStateBaseParams<StartExecutionSyncTaskParameters>, "Resource">,
  ) {
